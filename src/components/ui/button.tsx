...
const buttonVariants = cva(
  "group/button press inline-flex shrink-0 items-center justify-center rounded-lg border-2 border-border bg-clip-padding text-sm font-bold whitespace-nowrap outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/40 focus-visible:shadow-brutal-lg disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-brutal",
        outline:
          "bg-card text-foreground shadow-brutal",
        secondary:
          "bg-secondary text-secondary-foreground shadow-brutal",
        ghost:
          "border-transparent bg-transparent text-foreground shadow-none hover:bg-muted hover:shadow-brutal-sm",
        destructive:
          "bg-destructive text-destructive-foreground shadow-brutal",
